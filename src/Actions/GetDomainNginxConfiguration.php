 ...
 */
readonly class GetDomainNginxConfiguration
{
    use HasNginxConfiguration;
    use ParsesResponse;

    /**
     * GetDomainNginxConfiguration constructor.
     */
     ...
     */
    public function handle(int $serverId, int $siteId, int $domainRecordId): NginxConfiguration
    {
